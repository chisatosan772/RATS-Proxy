          ...
          {phase === 'result' && proxyLine ? (() => {
            ...
            return (
              ...
              >
                ...
                {/* Port */}
                <div className="mb-4">
                  <label className="text-xs font-medium text-fg-muted uppercase tracking-wide">Port</label>
                  <div className="mt-2 flex items-center gap-2">
                    <div className="flex-1 rounded-xl bg-[var(--color-input-bg)] px-4 py-3 text-sm text-fg font-mono">
                      {port}
                    </div>
                    <button
                      type="button"
                      onClick={() => void copyField(port)}
                      className="min-h-touch shrink-0 rounded-xl border border-glass-border p-3 text-fg transition-all hover:border-accent hover:shadow-glow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
                      title="Copy"
                    >
                      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* Password */}
                <div className="mb-4">
                  <label className="text-xs font-medium text-fg-muted uppercase tracking-wide">Password</label>
                  <div className="mt-2 flex items-center gap-2">
                    <code className="flex-1 break-all rounded-xl bg-[var(--color-input-bg)] px-4 py-3 text-sm text-fg font-mono">
                      {password}
                    </code>
                ...
                <div className="pt-4 border-t border-glass-border">
                  <label className="text-xs font-medium text-fg-muted uppercase tracking-wide flex items-center gap-2 mb-2">
                    <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="flex-1 break-all rounded-xl bg-[var(--color-input-bg)] px-4 py-3 text-xs text-fg font-mono">
                      {`curl -x ${host}:${port} -U "${username}:${password}" ipinfo.io`}
                    </code>
                    <button
                      type="button"
                      onClick={() => void copyField(`curl -x ${host}:${port} -U "${username}:${password}" ipinfo.io`)}
                      className="min-h-touch shrink-0 rounded-xl border border-glass-border p-3 text-fg transition-all hover:border-accent hover:shadow-glow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent"
                      title="Copy"
                    >
                      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
